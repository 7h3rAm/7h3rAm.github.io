...
===============
date: 13/Nov/2019
summary: This is a writeup for HackTheBox machine CronOS.
tags: hackthebox, writeup

## Overview
This is a writeup for HTB VM [Cronos](https://www.hackthebox.eu/home/machines/profile/11). Here are stats for this machine from [machinescli](https://github.com/7h3rAm/machinescli):

![writeup.overview.machinescli](/static/files/posts_htb_cronos/machinescli.png.webp)
