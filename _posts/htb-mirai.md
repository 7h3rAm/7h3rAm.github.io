...
===============
date: 12/Nov/2019
summary: This is a writeup for HackTheBox machine Mirai.
tags: hackthebox, writeup

## Overview
This is a writeup for HTB VM [Mirai](https://www.hackthebox.eu/home/machines/profile/64). Here are stats for this machine from [machinescli](https://github.com/7h3rAm/machinescli):

![writeup.overview.machinescli](/static/files/posts_htb_mirai/machinescli.png.webp)
