...
Following is the part 2 in the series of posts I started back in August
...
This post follows the [Gera's Warming Up on Stack #1 -
Solutions](/2012/8/27/geras-wuos-stack1-solutions/) post and if you have
...
and exploit this program so that it prints the `you win!` message to
stdout.
